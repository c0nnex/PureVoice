...
namespace LiteNetLib.Utils
{
    ...
    public class NetSerializer
    {
        ...
        private ClassInfo<T> RegisterInternal<T>()
        {
            ...
            sb.AppendLine("LitenetLib RegisterType: " + t.ToString()+" "+GetHash(t).ToString("X"));
#endif
            for (int i = 0; i < props.Length; i++)
            {
                ...
                {
#if DEBUG
                    sb.AppendLine("-- " + i + " " + property.Name + " " + propertyType.ToString());
#endif
...
#if DEBUG
            NetDebug.WriteDebug(NetLogLevel.Info, sb.ToString());
#endif
