...
namespace PureVoiceTest
{
    class Program
    {
        ...
        private static void _vs_VoiceClientConnected(string clientGUID, string teamspeakID, ushort teamspeakClientID,string clientName, bool micMuted, bool speakersMuted)
        {
            _vs.ConfigureClient(teamspeakClientID, "Halifax", false);
            _vs.SendUpdate(teamspeakClientID, new PureVoice.VoiceLocationInformation(teamspeakClientID) { });
